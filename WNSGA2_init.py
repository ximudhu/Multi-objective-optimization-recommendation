...
from Wgenetic_operator1 import *
from objectfun import *
from _pydecimal import Decimal,Context,ROUND_HALF_UP
def WNSGA2_init(predictedlist, trainrating,wratmatrix, proberating, object_num,population_size, rem_length, gmax,pc, pm):#trainrating
    #object_num:目标函数
    ...
    print(3)
    #population = WWinit_population (population_size,wratmatrix,predictedlist,rem_length)
    population = init_population(population_size, wratmatrix, predictedlist, rem_length)
    #population = Winit_population (population_size,wratmatrix,predictedlist,rem_length)
    #population = WWWinit_population (population_size, wratmatrix, predictedlist, rem_length)
    population,new_Front = fast_non_dominated_sort(population, object_num)
    print(4)
    ...
    for gen in range(gmax):
        ...
        if gen < 1000:
           ...
           a , b = 1,10
        print(a,b)
        offspring_population = Wgenetic_operator1(population, pc, pm, wratmatrix, object_num, tournament_size,predictedlist,a,b)
