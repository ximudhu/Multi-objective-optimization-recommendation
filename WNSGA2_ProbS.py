...
#from dominating_relationship import *
def WNSGA2_ProbS(predictedlist, trainrating,ratmatrix, proberating, object_num,population_size, rem_length,gmax, pc, pm,initpopulation):#trainrating
    #object_num:目标函数
    ...
    #initpopulation = Winit_population (population_size,ratmatrix,predictedlist,rem_length)
    ...
    for gen in range(gmax):
        ...
        if gen < 1000:
           ...
           a , b = 1,10
        offspring_population = Wgenetic_operator(population, pc, pm, ratmatrix, object_num, tournament_size,predictedlist,a,b)
