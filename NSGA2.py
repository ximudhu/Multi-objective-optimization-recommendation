...
def NSGA2(ratmatrix,predictedlist,proberating,object_num,population_size,rem_length,gmax,pc,pm):#population_size,trainrating,ratmatrix,wratmatrix,rem_length
    #object_num:目标函数
    ...
    population = init_population(population_size,ratmatrix,predictedlist,rem_length) #初始化种群
    print(3)
    ...
    for gen in range(gmax):
        offspring_population = genetic_operator(population, pc, pm, ratmatrix,object_num,tournament_size,predictedlist)# 父代种群进行交叉、变异生成子代种群
        print(7)
